...
export const RegistrationForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-5 md:mx-12 lg:mx-auto lg:grid lg:grid-cols-12 h-screen md:h-[calc(100vh-145px)]">
      <div className="col-start-8 col-end-12 lg:mx-auto max-w-[500px]">
        <div className="mb-10 w-[295px] mx-auto flex flex-col justify-center items-center mt-32 lg:w-[400px]">
          <Logo textClasses="lg:mt-0 text-center"/>
        </div>

        <form className="w-full max-w space-y-4" onSubmit={handleSubmit}>
          <div className="flex items-center justify-center gap-5">
            <label className="block text-sm md:text-md lg:text-lg text-white font-medium mb-2">
              Nombre:
            </label>
            <input
              type="text"
              ...
              className="w-full md:px-4 md:py-2 bg-white rounded border-2 border-gray-300 focus:border-yellow-400 focus:outline-none"
            />
          ...
          <div className="flex items-center justify-center gap-2">
            <label className="block text-sm md:text-md lg:text-lg text-white font-medium mb-2">
              ...
              <span className="ml-2 text-xs ">fecha de nacimiento</span>
            </label>
